namespace E_Commerce {
    ...
    public sealed class AssembleComputerTransform : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:ns0=""http://Production.AssembleComputer"" xmlns:s0=""http://E_Commerce.CustomerOrder"">
  <xsl:output omit-xml-declaration=""yes"" method=""xml"" version=""1.0"" />
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s0:CustomerOrder"" />
  </xsl:template>
  <xsl:template match=""/s0:CustomerOrder"">
    <ns0:AssembleComputer>
      <OrderNumber>
      ...
      <ComponentsList>
        ...
        private const string _strTrgSchemasList0 = @"Production.AssembleComputer";
        
        private const global::Production.AssembleComputer _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"Production.AssembleComputer";
                return _TrgSchemas;
            }
        }
    }
