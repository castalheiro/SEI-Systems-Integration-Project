namespace E_commerce {
    ...
    [Microsoft.XLANGs.BaseTypes.DistinguishedFieldAttribute(typeof(System.String), "Price", XPath = @"/*[local-name()='OrderConfirmation' and namespace-uri()='http://E_commerce.OrderConfirmation']/*[local-name()='Price' and namespace-uri()='']", XsdType = @"string")]
