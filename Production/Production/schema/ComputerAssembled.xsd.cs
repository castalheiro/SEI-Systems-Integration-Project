namespace Production {
    ...
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::Production.schema.OrderNumber), XPath = @"/*[local-name()='ComputerAssembled' and namespace-uri()='http://Production.ComputerAssembled']/*[local-name()='OrderNumber' and namespace-uri()='']", XsdType = @"string")]
...
<xs:schema xmlns=""http://Production.ComputerAssembled"" xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:ns0=""https://Production.PropertySchema"" targetNamespace=""http://Production.ComputerAssembled"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:annotation>
    <xs:appinfo>
      <b:imports>
    ...
    <xs:annotation>
      <xs:appinfo>
        <b:properties>
          ...
          <b:property name=""ns0:OrderNumber"" xpath=""/*[local-name()='ComputerAssembled' and namespace-uri()='http://Production.ComputerAssembled']/*[local-name()='OrderNumber' and namespace-uri()='']"" />
        </b:properties>
      </xs:appinfo>
    </xs:annotation>
    <xs:complexType>
